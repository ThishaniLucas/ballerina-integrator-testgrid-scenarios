...
write_properties_to_data_bucket() {
    ...
    curl -v -X POST "http://130.211.231.99:${node_port}/amazons3/ballerina-integrator-bucket3" -o curl-out
    cat curl-out
    curl -v -X POST "http://35.225.170.171:${node_port}/amazons3/ballerina-integrator-bucket4" -o curl-out
    cat curl-out
